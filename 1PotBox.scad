...
//				label(tx="+", sz=3.5, font="Futura");
		...
		// right face
		rotate([90, 180, 270]) {
			translate([offsetJackOutY + 19, -offsetJackOutZ, wallD-textDepth])
				label(tx="out", sz=8, font="Futura");
			translate([offsetJackOutY + 41, -offsetJackOutZ, wallD-textDepth])
				arrow(width=20, height=10, depth=1);
		}

		// left face
		rotate([90, 180, 90]) {
			translate([-offsetJackInY -40, -offsetJackInZ, offsetJackInX+wallD-textDepth])
				label(tx="in", sz=8, font="Futura", depth=2);
			translate([-offsetJackInY -22, -offsetJackInZ-1, offsetJackInX+wallD-textDepth])
